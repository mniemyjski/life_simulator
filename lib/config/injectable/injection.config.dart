...
import '../../app/income/cubit/income_cubit.dart' as _i8;
import '../../app/job/cubit/job_cubit.dart' as _i9;
import '../../app/learning/cubit/learning_cubit.dart' as _i10;
import '../../app/money/cubit/money_cubit.dart' as _i7;
import '../../app/personality/cubit/house/house_cubit.dart' as _i14;
import '../../app/personality/cubit/meal/meal_cubit.dart' as _i11;
import '../../app/personality/cubit/transport/transport_cubit.dart' as _i12;
...
import '../../app/stats/cubit/stats_cubit.dart' as _i15;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i8.IncomeCubit>(() => _i8.IncomeCubit(
      moneyCubit: get<_i7.MoneyCubit>(), saveCubit: get<_i4.SaveCubit>()));
  gh.lazySingleton<_i9.JobCubit>(() => _i9.JobCubit(
      saveCubit: get<_i4.SaveCubit>(),
      incomeCubit: get<_i8.IncomeCubit>(),
  ...
  gh.lazySingleton<_i10.LearningCubit>(() => _i10.LearningCubit(
      ...
      skillsCubit: get<_i5.SkillsCubit>(),
      moneyCubit: get<_i7.MoneyCubit>()));
  gh.lazySingleton<_i11.MealCubit>(() => _i11.MealCubit(
      incomeCubit: get<_i8.IncomeCubit>(),
      saveCubit: get<_i4.SaveCubit>(),
      timeSpendCubit: get<_i6.TimeSpendCubit>()));
  gh.lazySingleton<_i12.TransportCubit>(() => _i12.TransportCubit(
      moneyCubit: get<_i7.MoneyCubit>(),
      incomeCubit: get<_i8.IncomeCubit>(),
      saveCubit: get<_i4.SaveCubit>(),
      timeSpendCubit: get<_i6.TimeSpendCubit>()));
  gh.lazySingleton<_i13.DateCubit>(() => _i13.DateCubit(
      saveCubit: get<_i4.SaveCubit>(),
      timeSpendCubit: get<_i6.TimeSpendCubit>(),
      learningCubit: get<_i10.LearningCubit>(),
      incomeCubit: get<_i8.IncomeCubit>()));
  gh.lazySingleton<_i14.HouseCubit>(() => _i14.HouseCubit(
      moneyCubit: get<_i7.MoneyCubit>(),
      incomeCubit: get<_i8.IncomeCubit>(),
      saveCubit: get<_i4.SaveCubit>(),
      timeSpendCubit: get<_i6.TimeSpendCubit>()));
  gh.lazySingleton<_i15.StatsCubit>(() => _i15.StatsCubit(
      timeSpend: get<_i6.TimeSpendCubit>(),
      saveCubit: get<_i4.SaveCubit>(),
      dateCubit: get<_i13.DateCubit>()));
  return get;
}

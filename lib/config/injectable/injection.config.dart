...
import '../../app/business/repositories/products_repository.dart' as _i14;
import '../../app/business/repositories/research_repository.dart' as _i15;
...
import '../../app/money/cubit/money/money_cubit.dart' as _i24;
...
import '../../app/money/repositories/transactions_repository.dart' as _i20;
import '../../app/new_game/new_game_cubit.dart' as _i25;
...
import '../../app/skills/repositories/skills_repository.dart' as _i16;
import '../../app/stats/cubit/stats_cubit.dart' as _i39;
import '../../app/stats/repositories/stats_repository.dart' as _i17;
...
import '../../app/time_spend/repositories/time_spend_repository.dart' as _i19;
import '../../app/tutorial/cubit/tutorial_cubit.dart' as _i21;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i14.ProductsRepository>(() => _i14.ProductsRepository());
  gh.lazySingleton<_i15.ResearchRepository>(() => _i15.ResearchRepository());
  gh.lazySingleton<_i16.SkillsRepository>(() => _i16.SkillsRepository());
  gh.lazySingleton<_i17.StatsRepository>(() => _i17.StatsRepository());
  gh.lazySingleton<_i18.StockMarketRepository>(
      () => _i18.StockMarketRepository());
  gh.lazySingleton<_i19.TimeSpendRepository>(() => _i19.TimeSpendRepository());
  gh.lazySingleton<_i20.TransactionsRepository>(
      () => _i20.TransactionsRepository());
  gh.lazySingleton<_i21.TutorialCubit>(() => _i21.TutorialCubit());
  gh.factory<_i22.FreelanceDoneCubit>(
      () => _i22.FreelanceDoneCubit(get<_i9.FreelanceRepository>()));
  gh.factory<_i23.InstrumentsCubit>(
      () => _i23.InstrumentsCubit(get<_i18.StockMarketRepository>()));
  gh.lazySingleton<_i24.MoneyCubit>(
      () => _i24.MoneyCubit(get<_i20.TransactionsRepository>()));
  gh.lazySingleton<_i25.NewGameCubit>(() => _i25.NewGameCubit(
        get<_i18.StockMarketRepository>(),
        get<_i16.SkillsRepository>(),
        get<_i19.TimeSpendRepository>(),
        get<_i20.TransactionsRepository>(),
      ));
  gh.factoryParam<_i26.ProductDetailsCubit, int, int>((
    businessId,
    productId,
  ) =>
      _i26.ProductDetailsCubit(
        get<_i8.EmployeeRepository>(),
        get<_i14.ProductsRepository>(),
        businessId,
        productId,
      ));
  gh.factory<_i27.SkillsCubit>(
      () => _i27.SkillsCubit(get<_i16.SkillsRepository>()));
  gh.factory<_i28.TimeSpendCubit>(
      () => _i28.TimeSpendCubit(get<_i19.TimeSpendRepository>()));
  gh.lazySingleton<_i29.BusinessesCubit>(() => _i29.BusinessesCubit(
        get<_i25.NewGameCubit>(),
        get<_i5.BusinessesRepository>(),
      ));
  gh.lazySingleton<_i30.DatabaseCubit>(
      () => _i30.DatabaseCubit(get<_i25.NewGameCubit>()));
  gh.lazySingleton<_i31.DepositCubit>(
      () => _i31.DepositCubit(get<_i25.NewGameCubit>()));

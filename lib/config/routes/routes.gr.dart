...
import '../../app/personality/models/house/house_model.dart' as _i23;
...
class AppRouter extends _i21.RootStackRouter {
  ...
  List<_i21.RouteConfig> get routes => [
        _i21.RouteConfig(HomeRoute.name, path: '/'),
        _i21.RouteConfig(SettingsRoute.name, path: '/settings-screen'),
        _i21.RouteConfig(GameRoute.name, path: '/game-screen'),
        _i21.RouteConfig(JobRoute.name, path: '/job-screen'),
        _i21.RouteConfig(TimeSpendRoute.name, path: '/time-spend-screen'),
        _i21.RouteConfig(LearningRoute.name, path: '/learning-screen'),
        _i21.RouteConfig(IncomeRoute.name, path: '/income-screen'),
        _i21.RouteConfig(PersonalityRoute.name, path: '/personality-screen'),
        _i21.RouteConfig(HouseRoute.name, path: '/house-screen'),
        _i21.RouteConfig(CarRoute.name, path: '/car-screen'),
        _i21.RouteConfig(BankRoute.name, path: '/bank-screen'),
        _i21.RouteConfig(MedicinesRoute.name, path: '/medicines-screen'),
        _i21.RouteConfig(RealAssetsRoute.name, path: '/real-assets-screen'),
        _i21.RouteConfig(BuildAssetsRoute.name, path: '/build-assets-screen'),
        _i21.RouteConfig(BuyAssetsRoute.name, path: '/buy-assets-screen'),
        _i21.RouteConfig(AssetRoute.name, path: '/asset-screen'),
        _i21.RouteConfig(TenantsRoute.name, path: '/tenants-screen'),
        _i21.RouteConfig(StockMarketRoute.name, path: '/stock-market-screen'),
        _i21.RouteConfig(InstrumentRoute.name, path: '/instrument-screen'),
        _i21.RouteConfig(FoodsRoute.name, path: '/foods-screen')
      ];
}
...
/// generated route for
/// [_i3.GameScreen]
class GameRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for
/// [_i4.JobScreen]
class JobRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.TimeSpendScreen]
class TimeSpendRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for
/// [_i6.LearningScreen]
class LearningRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for
/// [_i7.IncomeScreen]
class IncomeRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.HouseScreen]
class HouseRoute extends _i21.PageRouteInfo<HouseRouteArgs> {
  HouseRoute({_i22.Key? key, required _i23.ETypeHouse eTypeHouse})
...
class HouseRouteArgs {
  ...
  final _i23.ETypeHouse eTypeHouse;
...
/// generated route for
/// [_i10.CarScreen]
class CarRoute extends _i21.PageRouteInfo<void> {
...
class MedicinesRoute extends _i21.PageRouteInfo<void> {
...
class RealAssetsRoute extends _i21.PageRouteInfo<void> {
...
class BuildAssetsRoute extends _i21.PageRouteInfo<void> {
...
class BuyAssetsRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for
/// [_i16.AssetScreen]
class AssetRoute extends _i21.PageRouteInfo<AssetRouteArgs> {
  AssetRoute({_i22.Key? key, required String id})
...
/// generated route for
/// [_i17.TenantsScreen]
class TenantsRoute extends _i21.PageRouteInfo<void> {
...
class StockMarketRoute extends _i21.PageRouteInfo<void> {
...
class InstrumentRoute extends _i21.PageRouteInfo<InstrumentRouteArgs> {
  InstrumentRoute({_i22.Key? key, required String id})
...
/// generated route for
/// [_i20.FoodsScreen]
class FoodsRoute extends _i21.PageRouteInfo<void> {

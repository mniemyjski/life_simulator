...
class _$_Database implements _Database {
  ...
  final List<Job> _jobsDB;
  @override
  List<Job> get jobsDB {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_jobsDB);
  }

  final List<Learning> _learningsDB;
  @override
  ...
  List<House> get housesDB {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_housesDB);
  }

  final List<Transport> _transportsDB;
  @override
  List<Transport> get transportsDB {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_transportsDB);
  }

  final List<GameEvent> _eventsDB;
  @override
  List<GameEvent> get eventsDB {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_eventsDB);
  }

  final List<Medicine> _medicinesDB;
  @override
  List<Medicine> get medicinesDB {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_medicinesDB);
  }

  final List<Asset> _assetsDB;
  @override
  ...
  final List<Instrument> _instrumentDB;
  @override
  List<Instrument> get instrumentDB {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_instrumentDB);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._instrumentDB, _instrumentDB));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_instrumentDB));
...
abstract class _Database implements Database {
  const factory _Database(
      ...
      required final List<Asset> assetsDB,
      required final List<Tenant> tenantsDB,
      required final List<Instrument> instrumentDB}) = _$_Database;

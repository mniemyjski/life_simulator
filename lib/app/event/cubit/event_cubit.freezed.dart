...
EventState _$EventStateFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    ...
    default:
      throw CheckedFromJsonException(json, 'runtimeType', 'EventState',
...
mixin _$EventState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<GameEvent> events, DateTime currentDate)
        loaded,
  }) =>
...
class _$Loaded implements Loaded {
  _$Loaded(
      {required this.events, required this.currentDate, final String? $type})
      : $type = $type ?? 'loaded';
  ...
  @override
  String toString() {
    return 'EventState.loaded(events: $events, currentDate: $currentDate)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(events, currentDate);
  }
...
abstract class Loaded implements EventState {
  factory Loaded(
      ...
      required final DateTime currentDate}) = _$Loaded;
